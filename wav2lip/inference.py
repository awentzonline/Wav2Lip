...
class Wav2LipInference:
    ...
    def lipsync(self, full_frames, wav):
        """
        Full frames should be a list of numpy arrays dtype=uint8
        wav should be sampled at 16000hz
        """
        fps = self.fps
    ...
    def lipsync_file(self, face_filename, audio_filename, output_filename, tmpdir=None):
